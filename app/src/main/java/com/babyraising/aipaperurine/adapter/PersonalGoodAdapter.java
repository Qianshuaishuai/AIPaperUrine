...
public class PersonalGoodAdapter extends RecyclerView.Adapter<PersonalGoodAdapter.ViewHolder> {
    ...
    public PersonalGoodAdapter(List<PersonalActBean> mList) {
        this.mList = mList;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycleview_person_good, parent, false);
