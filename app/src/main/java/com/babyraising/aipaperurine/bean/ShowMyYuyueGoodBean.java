...
public class ShowMyYuyueGoodBean {
    private String YUYUECARD_ID;
    private String GOODS_OD;
    ...
    public String getYUYUECARD_ID() {
        return YUYUECARD_ID;
    }

    public void setYUYUECARD_ID(String YUYUECARD_ID) {
        this.YUYUECARD_ID = YUYUECARD_ID;
    }

    public String getGOODS_OD() {
        return GOODS_OD;
    }

    public void setGOODS_OD(String GOODS_OD) {
        this.GOODS_OD = GOODS_OD;
    }
