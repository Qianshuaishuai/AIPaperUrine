...
public class FindFragment extends Fragment {
    ...
    private void initView() {
        findLayout = (LinearLayout) getActivity().findViewById(R.id.layout_tab_find);
        rankLayout = (LinearLayout) getActivity().findViewById(R.id.layout_tab_rank);

        findTv = (TextView) getActivity().findViewById(R.id.tv_tab_find);
        rankTv = (TextView) getActivity().findViewById(R.id.tv_tab_rank);

        findView = (View) getActivity().findViewById(R.id.view_tab_find);
        rankView = (View) getActivity().findViewById(R.id.view_tab_rank);
